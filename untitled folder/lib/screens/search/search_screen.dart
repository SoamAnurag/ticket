    ...
    return Scaffold(
      ...
      body: ListView(
        padding: EdgeInsets.symmetric(
            horizontal: Layout.getWidth(20,context), vertical: Layout.getHeight(20,context)),
        children: [
          const Gap(40),
          Text('What are\nyou looking for?',
          ...
          Container(
            padding: EdgeInsets.symmetric(
                vertical: Layout.getWidth(12,context),
                horizontal: Layout.getHeight(12,context)),
            decoration: BoxDecoration(
              color: ColorManager.white,
              borderRadius: BorderRadius.circular(Layout.getWidth(10,context)),
            ),
            child: Row(
              children: [
                Icon(
          ...
          InkWell(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(
                  vertical: Layout.getHeight(15,context),
                  horizontal: Layout.getWidth(15,context)),
              decoration: BoxDecoration(
          ...
          Row(
            ...
            children: [
              Container(
                height: Layout.getHeight(400,context),
                width: width * 0.42,
                padding: EdgeInsets.symmetric(
                    vertical: Layout.getHeight(15,context),
                    horizontal: Layout.getWidth(15,context)),
                decoration: BoxDecoration(
                  color: ColorManager.white,
                  borderRadius: BorderRadius.circular(Layout.getHeight(20,context)),
                  boxShadow: [
                    BoxShadow(
                ...
                child: Column(
                  children: [
                    Container(
                      height: Layout.getHeight(190,context),
                      decoration: BoxDecoration(
                          borderRadius:
                              BorderRadius.circular(Layout.getHeight(12,context)),
              ...
              Column(
                children: [
                  Container(
                    width: width * 0.44,
                    height: Layout.getHeight(195,context),
                    decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(
                        vertical: Layout.getHeight(45,context),
                        horizontal: Layout.getWidth(15,context)),
